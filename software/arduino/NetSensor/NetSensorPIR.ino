...
#define INTERVAL_PIR_DETECTION 240000L
...
#ifdef DOOR_SENSOR
  sendRadioData();
  if (digitalRead(PRIMARY_BUTTON_PIN)==sensor1){//go to sleep if status hasn't changed during data transmission
...
#ifdef MOTION_SENSOR
    data_to_send[1]= (byte)sensor2;
#endif
#ifdef DOOR_SENSOR
    data_to_send[1]= (byte)sensor1;
#endif
