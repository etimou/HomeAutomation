...
'''
response = requests.get("https://www.services-rte.com/cms/open_data/v1/tempoLight")

data = response.json()['values']
todays_Color= data[date_in_ISOFormat]
if (todays_Color in ['BLUE', 'WHITE']):
    exit(0)
'''
...
data={"id":"secret", "xml":base64.b64encode(b'<valeurs><valeur donnee="150" valeur="MQ==" /><valeur donnee="151" valeur="MQ==" /><valeur donnee="156" valeur="MQ==" /></valeurs>')}
...
#<valeurs><valeur donnee="150" valeur="Mg==" /><valeur donnee="151" valeur="Mg==" /><valeur donnee="156" valeur="Mg==" /></valeurs>
